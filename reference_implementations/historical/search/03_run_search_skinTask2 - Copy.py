...
#
# Private archive source: PDARTS/Github/master/03_run_search_skinTask2 - Copy.py
# Original SHA-256: 3ffc46eac9bb9bbe7be657c21a37814a52b97b0e64b334cc2ec5627bd2099379
#
...
DEFAULT_SAVE_ROOT = "PROJECT_ROOT/output/eval_runs/0final/DonD/genotype"

DEFAULT_RUN_NAME  = "D_search_task_32"
# -----------------------------------------------------------------------------
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--seeds", type=str, default="0,1,2",
                   help="Comma-separated list of seeds (3 seeds => 3 genotypes).")
